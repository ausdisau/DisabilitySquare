    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="retro-topbar">
          ...
          <span className="text-white/80 text-xs">Privacy Policy</span>
        ...
        <div className="pt-10 max-w-3xl mx-auto px-4 py-8">
          ...
          <div className="retro-box mb-4">
            ...
            <div className="retro-box-content text-xs text-gray-500">
              <p>Last updated: March 2026. This policy explains what personal data we collect, how we use it, and your rights regarding that data. We are committed to protecting your privacy in accordance with the <em>Privacy Act 1988</em> (Cth) and the Australian Privacy Principles.</p>
            </div>
          </div>
                ...
                {[
                  {
                    ...
                    detail: "First name, last name, email address, date of birth (to verify age eligibility), and password hash. We do not store plain-text passwords.",
                  },
                  {
                    category: "Profile Information",
                    detail: "Display name, profile photo, bio, location (optional, not mandatory), disability type (optional, self-disclosed), and accessibility preferences.",
                  },
                  {
                    category: "Content You Post",
                    detail: "Posts, forum threads, comments, private messages, group contributions, journal entries (stored locally in your browser and not transmitted), and recognition badges you award.",
                  },
                  {
                    category: "Usage Data",
                    detail: "Page views, feature interactions, session timestamps, and device/browser type collected for security and product improvement. We do not use third-party advertising trackers.",
                  },
                  {
                    category: "Safety and Moderation Data",
                    detail: "Reports you make or receive, moderation decisions applied to your account, and audit logs required for legal compliance.",
                  },
                  {
                    category: "Health and Spoon Data",
                    detail: "Spoon tracker entries and health journal notes you create. This data is sensitive health information and is never shared with third parties.",
                  },
                ].map((item) => (
                  <div key={item.category} className="p-3">
                    <p className="font-bold text-[#1B4B8A] text-xs">{item.category}</p>
          ...
          <div className="retro-box mb-4">
            ...
            <div className="retro-box-content text-sm text-gray-700 space-y-2">
              ...
              <p>To exercise these rights, email <a href="mailto:privacy@disabilitysquare.com.au" className="text-[#1B4B8A] underline">privacy@disabilitysquare.com.au</a>. We will respond within 30 days.</p>
            </div>
          </div>
          ...
          <div className="retro-box mb-4">
            ...
            <div className="retro-box-content text-sm text-gray-700 space-y-1">
              <p>Privacy enquiries: <a href="mailto:privacy@disabilitysquare.com.au" className="text-[#1B4B8A] underline">privacy@disabilitysquare.com.au</a></p>
              <p>Safety enquiries: <a href="mailto:safety@disabilitysquare.com.au" className="text-[#1B4B8A] underline">safety@disabilitysquare.com.au</a></p>
              <p>OAIC: <a href="https://www.oaic.gov.au" target="_blank" rel="noopener noreferrer" className="text-[#1B4B8A] underline">www.oaic.gov.au</a></p>
            </div>
          </div>
